...
async def entrypoint(ctx: JobContext):
    ...
    vad = SileroVAD(
        threshold=0.8,                    # Sensitivity to speech (0.3-0.8)
        min_speech_duration=0.4,          # Ignore very brief sounds
...
def make_context() -> JobContext:
    room_options = RoomOptions(room_id="t5ln-txyc-x47k", name="Sandbox Agent", playground=True)
