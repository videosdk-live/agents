...
class Pipeline(EventEmitter[Literal["start"]], ABC):
    ...
    def __init__(self) -> None:
        ...
        self.audio_track: OutputAudioStreamTrack | None = None
    ...
    def _set_loop_and_audio_track(self, loop: asyncio.AbstractEventLoop, audio_track: OutputAudioStreamTrack) -> None:
