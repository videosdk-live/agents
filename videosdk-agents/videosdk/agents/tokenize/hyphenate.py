...
# in the public domain. Extended with ushyphmax.tex (2005-05-30, Kuiken)
# which is "permitted in any medium without royalty provided the copyright
...
@cache
def _get_hyphenator() -> EnglishHyphenator:
    return EnglishHyphenator(_PATTERNS, _EXCEPTIONS)
